<div class="w-full mx-auto space-y-8 p-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 px-1 lg:px-2 pb-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <a href="{{ fetch_data(route('savings.show', $saver?->user_id) ?? null) }}" class="w-full flex items-center justify-center gap-2 py-4 bg-surface border border-border-main text-slate-700 dark:text-white rounded-2xl text-xs font-black uppercase tracking-widest shadow-sm hover:bg-slate-50 transition-all">
